...
<div class="section_title_wrapper">
	<h2 class="heading"><?php echo htmlentities($database->getValue("restaurant", array("id" => $_GET["id"]), "nom")); ?></h2>
	...
	<div class="fliter_block">
		<div class="w-form">
			...
			<a class="primary_btn w-button wrapp_btn_null" href="#" onclick="seekRestaurantAdmin('/demo/administration/reservation/RESTAURANT/<?php echo $_GET["id"]; ?>/'); return false;">Rechercher</a> 
			<a class="primary_btn w-button wrapp_btn_null" href="/demo/administration/reservation/RESTAURANT/<?php echo $_GET["id"]; ?>">Voir les dernières réservation</a>
		</div>
	</div>
	...
	<div class="custom_table">
		...
		<?php
			if (isset($date))
			{
				...
				$database->setAsc();
				$database->selectJoin("reservation AS r", array(' users AS u ON idUser=u.id '), array("type" => $_GET["categorie"], "r.id" => $_GET["id"], "time" => array($timestamp, $timestamp+24*3600)), array("r.id", "idUser", "time", "nbrPersonne", "nom", "prenom"));
			}
			else
			{
