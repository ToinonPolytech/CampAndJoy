...
<div class="welcome_msg" data-ix="onpageload">
	<h1 class="h1_color">Création d'un compte</h1>
</div>
<div class="hero_section">
	<div class="w-container">
		<div class="step_section">
			<h4 class="step_head_title">Création d'un compte</h4>
			<div class="step_head">
		...
		<div class="w-form"> 
			<form id="form-compte" name="form-compte">
				<div id="part_1">
					...
					<input class="campandjoy_input w-input" maxlength="256" id="emplacement" name="emplacement" placeholder="Emplacement (Laisser vide s'il n'a pas de logement)" type="text">
					<label for="name">Date d'arrivée:</label>
					<input class="campandjoy_input w-input" maxlength="256" id="date_arrivee" name="date_arrivee" placeholder="Date d'arrivée (Laisser vide s'il n'y en a pas)" type="text">
					<label for="name">Date de départ:</label>
					<input class="campandjoy_input w-input" maxlength="256" id="date_depart" name="date_depart" placeholder="Date de départ (Laisser vide s'il n'y en a pas)" type="text">
					<label for="name">Nombre de comptes affiliés maximum :</label>
					<input class="campandjoy_input w-input" maxlength="256" id="comptes_affi" name="comptes_affi" value="1" type="number" min="1">
				...
				<div id="part_2" style="display:none;">
					<div class="horizontal_form">
						...
						<input class="campandjoy_input w-input" maxlength="256" id="prenom" name="prenom" placeholder="Prénom" type="text">
...
$("#access_level").on("change", function(){
	loadTo("<?php echo str_replace($_SERVER['DOCUMENT_ROOT'], '', i('droitsFormUser_administration.php')); ?>", {access_level : $("#access_level").val()}, "#part_3", "replace");
});
loadTo("<?php echo str_replace($_SERVER['DOCUMENT_ROOT'], '', i('droitsFormUser_administration.php')); ?>", {access_level : $("#access_level").val()}, "#part_3", "replace");
