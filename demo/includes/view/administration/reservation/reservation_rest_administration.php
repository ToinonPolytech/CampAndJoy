...
<div class="section_title_wrapper">
	...
	<div class="fliter_block">
		<div class="w-form">
			...
			<a class="primary_btn w-button wrapp_btn_null" href="/demo/<?php echo LANG_USER; ?>/administration/reservation/RESTAURANT/<?php echo $_GET["id"]; ?>">Voir les dernières réservation</a>
		</div>
	</div>
...
$(document).ready(function(){
	...
	$('#datepicker').datetimepicker({
		...
		onSelectDate:function(ct,$i){
			seekRestaurantAdmin('/demo/<?php echo LANG_USER; ?>/administration/reservation/RESTAURANT/<?php echo $_GET["id"]; ?>/');
		}
	});
});
