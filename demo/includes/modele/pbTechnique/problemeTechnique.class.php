...
class PbTech{
	...
	public function __construct($id, $idUsers=NULL, $timeCreated=NULL, $description=NULL, $isBungalow=NULL, $photos=""){
		$this->_id = $id;
		if ($id==NULL)
		{
	...
	public function saveToDb(){
		...
		{
			$database->update('problemes_technique', array("id" => $this->_id), array("photos" => $this->_photos, "idUsers" => $this->_idUser, "time_start" => $this->_timeCreated, "description" => $this->_description, "isBungalow" => $this->_isBungalow, "solved" => $this->_solved));
		}
		else
		{
			$database->create('problemes_technique', array("photos" => $this->_photos, "id" => $this->_id, "idUsers" => $this->_idUser, "time_start" => $this->_timeCreated, "description" => $this->_description, "isBungalow" => $this->_isBungalow, "solved" => $this->_solved));
